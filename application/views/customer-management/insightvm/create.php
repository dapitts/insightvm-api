							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group<?php echo form_error('security_console_host') ? ' has-error':''; ?>">
										...
										<input type="text" class="form-control" id="security_console_host" name="security_console_host" placeholder="insightvm.quadrantsec.com" value="<?php echo set_value('security_console_host'); ?>">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group<?php echo form_error('security_console_port') ? ' has-error':''; ?>">
										...
										<input type="text" class="form-control" id="security_console_port" name="security_console_port" placeholder="3780" value="<?php echo set_value('security_console_port'); ?>">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<input type="checkbox" id="use_proxy_server" name="use_proxy_server" value="1" <?php echo set_checkbox('use_proxy_server', '1'); ?>>
										<label for="use_proxy_server">Use Proxy Server</label>
									</div>
								</div>
							</div>
							<div id="proxy-settings" <?php echo set_value('use_proxy_server') === '1' ? 'style="display: block;"':''; ?>>
								<div class="row">
									<div class="col-md-6">
										<div class="form-group<?php echo form_error('proxy_username') ? ' has-error':''; ?>">
											...
											<input type="text" class="form-control" id="proxy_username" name="proxy_username" placeholder="Enter Proxy Username" value="<?php echo set_value('proxy_username'); ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group<?php echo form_error('proxy_password') ? ' has-error':''; ?>">
											...
											<div class="input-group show-hide-password">
												<input type="password" class="form-control" id="proxy_password" name="proxy_password" placeholder="Enter Proxy Password" value="<?php echo set_value('proxy_password'); ?>">
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group<?php echo form_error('proxy_host') ? ' has-error':''; ?>">
											...
											<input type="text" class="form-control" id="proxy_host" name="proxy_host" placeholder="Enter Proxy Host / IP address" value="<?php echo set_value('proxy_host'); ?>">
										</div>
									</div>
									<div class="col-md-6">
										<div class="form-group<?php echo form_error('proxy_port') ? ' has-error':''; ?>">
											<label class="control-label" for="proxy_port">proxy port</label>
											<input type="text" class="form-control" id="proxy_port" name="proxy_port" placeholder="Enter Proxy Port" value="<?php echo set_value('proxy_port'); ?>">
										</div>
									</div>
								</div>
							</div>
